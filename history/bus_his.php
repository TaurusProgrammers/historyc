...
$foto = "../reg/".$foto;
?>
<form action="../impre/imp_hist.php" method="post"  target="_blank">
...
<?php			
		...
		{
			cuadro_error("paciente: <b>".$_REQUEST["nom"]."</b> <b>".$_REQUEST["ape"]."</b> No Registrad@  <b><a href=../reg/reg_est.php target=\"_self\">Registrar?</a></b>"); ///colocar un enlace para registrar a la persona
		}
}		
echo "<br>";
