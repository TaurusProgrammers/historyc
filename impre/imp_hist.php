...
/***************  Header ***************************/
	$header_uno .= $pdf->Image("../thyme/images/logo_normal.jpg", 40, 5);
...
/************* Footer ************************/	
    ...
    $pdf->Cell(190, 20,"Constancia que se expide en Barranquilla, a los ___ dias del mes de ______  del  20___",0,0,'C');
    $pdf->Ln();
    $pdf->SetFont('Arial','B',12);
    $pdf->Cell(0, 10,"_________________",0,0, 'C');
    $pdf->Ln();
    $pdf->Cell(0, 0,"Firma y Sello",0,0, 'C');
